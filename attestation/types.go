...
func (a *TEEAttestation) VerifyTimestamp() error {
	...
	if a.Timestamp > now+MaxTimeWindow {
...
// BlockAttestation represents a block-level TEE attestation
type BlockAttestation struct {
	// Block ID this attestation applies to
	BlockID ids.ID `json:"blockId"`

	// TEE attestation for this block
	Attestation *TEEAttestation `json:"attestation"`

	// Polynomial commitment for block state
	PolynomialCommitment []byte `json:"polynomialCommitment,omitempty"`
}
